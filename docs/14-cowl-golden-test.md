...
Checked-in package: **[testdata/cowl-4-golden/](../testdata/cowl-4-golden/)**
...
| Annotated | `Cowl_WK061725_View 1 annotated.jpg` (red boxes on excluded hole groups, yellow origin marker) |
...
2. Submit all five artifact types from `testdata/cowl-4-golden/`.
